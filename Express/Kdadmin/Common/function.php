<?php
	...
	function getSenderstatus($status){
		return $status==1?'<b style="color:#008a00">在岗</b>':'<b style="color:#f00">离岗</b>';
	}
	//退款状态
	function getrefundstatus($status){
		return $status==-2?'<b style="color:#008a00">已退款</b>':'<b style="color:#f00">未退款</b>';
	}
