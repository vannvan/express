...
<div class="info-list">
	<ul>
		...
		<li><span style="letter-spacing: 0.5em;">收件人</span><span class="info-data"><?php echo ($data["name"]); ?></span></li>
		<li>收件地址<span class="info-data"><?php echo ($data["area"]); ?>-<?php echo ($data["location"]); ?>室</span></li>
		<li>手机号码<span class="info-data"><?php echo ($data["mobile"]); ?></span></li>	
		<li>付款时间<span class="info-data"><?php echo (date("Y-m-d H:i:s",$data["paytime"])); ?></span></li>
	</ul>

	<div style="width: 80%;height: 40px;margin:20px auto auto auto">校园快递团队根据下单时间和派送时间段进行派送，请不要着急！感谢您的支持！</div>
</div>
<style type="text/css">
