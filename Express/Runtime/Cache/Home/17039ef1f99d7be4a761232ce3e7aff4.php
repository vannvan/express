...
<div class="info-list">
	<ul>
		<li>订单编号<span class="info-data"><?php echo ($data["ordernum"]); ?></span></li>
		<li>快递公司<span class="info-data"><?php echo ($data["express"]); ?></span></li>
		<li>取件编号<span class="info-data"><?php echo ($data["number"]); ?></span></li>
		<li>备注信息<span class="info-data"><?php echo ((isset($data["note"]) && ($data["note"] !== ""))?($data["note"]):"无"); ?></span></li> <!-- 备注信息无字体大小18px -->
		<!-- <li>备注信息:<span class="info-data">一些备注信息</span></li> --><!--  有备注信息字体大小10px -->
		<li><span style="letter-spacing: 0.5em;margin-right: -0.5em">收件人</span><span class="info-data"><?php echo ($data["name"]); ?></span></li>
		<li>收件地址<span class="info-data"><?php echo ($data["area"]); ?>-<?php echo ($data["location"]); ?></span></li>
		<li>手机号码<span class="info-data"><?php echo ($data["mobile"]); ?></span></li>
		<button class="ui-btn-lg ui-btn-primary" style="margin-top: 15px;margin-left: 3%; width: 94%;" id="sub-btn" onclick='window.location="/Weixinpay/pay/?out_trade_no=<?php echo ($data["ordernum"]); ?>"'>
                提交订单
        </button>
	</ul>
</div>
